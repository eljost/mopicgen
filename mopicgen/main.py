...
def gen_jmol_spt(fn, orient, mos, mos_for_labels_fns, ifx, args):
    tpl_fn = "jmol.tpl"
    mo_fn_base = "mo_{}{}.png"
...
def handle_args(args):
    ...
    if args.check:
        ene_re = re.compile("Ene=")
        for molden, fn in moldens:
            enes = ene_re.findall(molden)
            print(f"Found {len(enes)} MOs in '{fn}'.")
            sys.exit()
...
def parse_args(args):
    ...
    mo_inp_group.add_argument("--check", action="store_true")
